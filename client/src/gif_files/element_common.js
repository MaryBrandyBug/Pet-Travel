...
$(function(){
   ...
   var wallpaper_sizes=[
      ...
      {w:1170,h:2532,	label:'iPhone 12/12 Pro',				force:true}		
   ];
...
$(function(){
   ...
   var zoom_toggle=function($o,ow,oh,offset){
      var $window=$o.parent();
      ...
      if (ow==$o.width()){
         ...
         $o.data({
            defScrollTop: $window.scrollTop(),
            defScrollLeft: $window.scrollLeft()
         });
         $window.animate({ 
            scrollLeft: (maxWidth-windowWidth)*(offset.x/windowWidth),
            scrollTop:  (maxHeight - windowHeight) * (offset.y / windowHeight) 
          }, 'fast'); 
      ...
      setTimeout(function(){
         ...
         $o.fadeIn('slow',function(){
            if (opw<ow){	
               $o.addClass('hand');
               $o.click(function(e){                 
                  zoom_toggle($o,ow,oh,{x:e.offsetX,y:e.offsetY});
               });
               $("[role='zoom']").click(function(e){
                  zoom_toggle($o,ow,oh,{x:e.offsetX,y:e.offsetY});
               });
            }else{
